  ...
  useEffect(() => {
    ;(async () => {
      ...
      do {
        ...
        chipIndexes = ShuffleService.makeRandomNumbers(
          originalText.length,
      ...
      const chippedText = ShuffleService.makeChippedText(
        originalText,
        chipIndexes
      )
      ...
      for (let i = 1; i < chippedText.length / 2; i++) {
        ...
        shortText =
          chippedText.slice(0, i) + chippedText.slice(chippedText.length - i)
